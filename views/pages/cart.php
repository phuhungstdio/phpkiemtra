                        ...
                        <tbody>
                            ...
                            <tr style="min-height: 20px;vertical-align: middle;">
                                <td class="cart_product">
                                    <a href="<?='http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/product_detail.php?product='.$product->product->id?>">
                                ...
                                <td class="cart_description" style="max-height: 200px; display: block; overflow: auto;">
                                    <p class="product-name"><a href="<?='http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/product_detail.php?product='.$product->product->id?>"><?= $product->product->name ?></a></p>
                                ...
                                <td class="quantity" data-id="<?=$product->product->id?>" style="text-align: center;">
                                    <form action="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/controller/giohang.php" method="post">
                                ...
                                <td class="cart_avail" style="font-size: 20px; color: red;">
                                    <form method="post" action="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/controller/giohang.php" >
