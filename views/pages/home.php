            ...
            <div class="block block-hot-deals">
                <div class="block-head">
                    <div class="block-title">
                        ...
                        <a class="button-radius view_more" href="<?='http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/product_of_category.php?category='.$category->id?>" title="View all" style="color: #FF7E7E;">View all<span class="icon"></span></a>
                    </div>
                </div>
