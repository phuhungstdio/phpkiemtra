                            ...
                            <div id="tab-categories" class="tab-panel active">
                                <ul class="home_categories">
                                    ...
                                    <li style="position: relative;">
                                        <a class="dropdown-toggle" href="<?='http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/product_of_category.php?category='.$parent->id?>" title="">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            ?>
                                            <li>
                                                <a href="<?='http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/product_of_category.php?category='.$child->id?>" style="vertical-align: middle; font-weight: bold;" title="">
