            ...
            <div class="">
                <div class="">
                    <ul class="top-bar-link top-bar-link-right dot">
                        <?php if (!$user) {?>
                            <li><a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/login.php">Sign in</a></li>
                            <li><a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/login.php">Sign up</a></li>
                        <?php
                        } else {
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="logo text-center">
                                <a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/home.php">
                        ...
                        <div class="col-lg-2 col-md-2  col-sm-2 col-xs-12  left_bar_icon" style="justify-content: space-around; display: flex;">
                            ...
                            <div class="block-wrap-cart ">
                                <div class="">
                                    <a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/pages/cart.php" class="fa fa-shopping-cart shopping_icon not0">
                                    </a>
                                </div>
