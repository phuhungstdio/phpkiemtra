            ...
            <div class="">
                <div class="">
                    <ul class="top-bar-link top-bar-link-right dot">
                        ...
                        <li><a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/login.php">Sign in</a></li>
                        <li><a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/login.php">Sign up</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-3 col-sm-4 col-xs-12">
                            <div class="logo text-center">
                                <a href="http://localhost:8081/baitap_gio_hang/web_gio_hang_php/views/layout/master.php">
